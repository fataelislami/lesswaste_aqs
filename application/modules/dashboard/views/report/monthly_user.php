                                        ...
                                        <table class="table zero-configuration dataTable" id="monthly" role="grid"
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><a target="_blank" href="https://wa.me/<?= phone($key->phone) ?>?text=Assalamualaikum+Less+Wasters+%21%0D%0AHai+kak+<?= $key->name?>%0D%0ATerima+kasih+masih+setia+untuk+bersedekah+sampah+di+Bulan+<?= bulan($month)?>+ini+bersama+Aqsyanna+Less+Waste%0D%0A%0D%0ABulan+ini+kamu+berhasil+mengumpulkan+sampah+sebanyak+<?= $key->total_weight?>+gram%0D%0A%0D%0AKami+ucapkan+jazakallah+khairan%2C+terima+kasih+banyak+kepada+kak+Nama+yang+sudah+istiqamah+dalam+kebaikan.%0D%0A%0D%0AJadilah+agen+perubahan%2C+mari+ubah+sampah+menjadi+sedekah..%21+Bersihkan+lingkungan%2C+dapatkan+keberkahan..%21%0D%0A%0D%0A%23SedekahSampahKeAqsyannaAja" class="btn btn-primary"><i class="fa fa-whatsapp"></i> Whatsapp</a></td>
                                                </tr>
                                                <?php $i++?>
                                                <?php }?>
                                                <?php }else{?>
