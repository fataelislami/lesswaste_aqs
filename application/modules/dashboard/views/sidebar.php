    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="sidebar" data-menu="menu-navigation">
            <li class="nav-item"><a href="<?= base_url()?>dashboard/data_sedekah"><i class="feather icon-zap"></i><span class="menu-title" data-i18n="">Data Sedekah</span></a>
            </li>
            <li class="nav-item"><a href="<?= base_url()?>dashboard/users"><i class="feather icon-zap"></i><span class="menu-title" data-i18n="">Lesswaster</span></a>
            </li>
